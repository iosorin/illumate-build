...
$(document).ready(function(){function e(){window.location=newLocation}var t;$(".preloader").fadeIn(function(){$("body").jpreLoader({},function(){setTimeout(function(){$(".preloader").fadeOut(900,function(){$("body").removeClass("beforePreload")})},2100)})}),$(".page-link").click(function(t){t.preventDefault(),newLocation=this.href,$("body").fadeOut("slow",e)}),$(".drag-slider .start").draggable({axis:"x",revert:!0,containment:".drag-slider"}),$(".drag-slider .finish").droppable({drop:function(){$(".menu-wrap").addClass("active"),$(".menu-trigger").addClass("menu-active"),$("body").addClass("beforePreload")}}),$(".menu-trigger").on("click",function(){$(this).toggleClass("menu-active"),$(".menu-wrap").toggleClass("active"),$("body").toggleClass("beforePreload")}),$(".js-modal-btn").modalVideo(),$(window).on("scroll",function(e){var t=!1,o=0,i=0;if($(window).mousemove(function(e){!0===t&&($(window).scrollTop($(window).scrollTop()+(o-e.pageY)),$(window).scrollLeft($(window).scrollLeft()+(i-e.pageX)))}),$(window).mousedown(function(e){t=!0,o=e.pageY,i=e.pageX}),$(window).mouseup(function(){t=!1}),$(".progress-bar").length){var a=Math.max($("body").height(),$(".content").height()),n=$(window).scrollTop()/(a-$(window).height())*100;$(".progress-bar .inner").height(n+"%")}}),$(window).on("mousewheel DOMMouseScroll",function(e){var t;e.preventDefault(),t="mousewheel"===e.type?e.originalEvent.wheelDelta>0?"-=":"+=":e.originalEvent.detail<0?"-=":"+=",$("html, body").stop().animate({scrollTop:t+100},200,"linear")}),(t=jQuery).fn.timeline=function(){var e={item:t(this).find(".tl-item"),activeClass:"tl-active"};e.item.eq(0).addClass(e.activeClass);var o=e.item.length;t(window).scroll(function(){var i,a,n=t(this).scrollTop();e.item.each(function(s){a=t(this).offset().top,i=t(this).height()+t(this).offset().top,t(this),s==o-2&&n>a+t(this).height()/2?(e.item.removeClass(e.activeClass),e.item.last().addClass(e.activeClass)):n<=i-60&&n>=a&&(e.item.removeClass(e.activeClass),t(this).addClass(e.activeClass))})})},$(".timeline").timeline(),function(e){function t(){window.matchMedia("(max-width: 800px)").matches?e(".ct.menu-trigger").removeClass("home-trig").addClass("mobile"):e(".ct.menu-trigger").removeClass("mobile")}t(),window.addEventListener("resize",t,!1)}(jQuery),$(function(e){var t=0,o=0,i=0,a=0,n=1/30;$(window).on("mousemove click",function(e){var i=Math.max(-100,Math.min(100,$(window).width()/2-e.clientX)),a=Math.max(-100,Math.min(100,$(window).height()/2-e.clientY));t=30*i/100,o=20*a/100}),function e(){i+=(t-i)*n,a+=(o-a)*n,translate="translate("+i+"px, "+a+"px) scale(1)",$(".pyramid-inner").css({"-webit-transform":translate,"-moz-transform":translate,transform:translate}),window.requestAnimationFrame(e)}()})});var s_app=new s_App;function s_App(){var e={datas:{},audios:{},audio:1,audio_playing:!1};return e.flow=document.getElementById("start-flow"),new Promise(function(t,o){for(var i=0,a=1;a<=3;a++){var n="sound/flow-"+a+".mp3",s=new Audio(n);e.audios["id-"+a]=s,s.setAttribute("preload","auto"),s.setAttribute("controls","controls"),s.setAttribute("loop",!0),s.setAttribute("data-order",a),s.addEventListener("canplaythrough",function(e){3==++i&&t("Audios Loaded!")})}}).then(function(){e.flow.addEventListener("mousedown",t),document.addEventListener("mouseleave",o),document.addEventListener("mouseup",o),e.flow.addEventListener("touchstart",o)}),e;function t(){e.audio_playing=!0,document.body.className="playing audio-"+e.audio,e.audios["id-"+e.audio].play()}function o(){var t=e.audios["id-"+e.audio];t.pause(),t.currentTime=0,e.audio_playing&&(e.audio++,document.body.className="",e.audio_playing=!1,e.audio>3&&(e.audio=1))}}